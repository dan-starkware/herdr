...
impl App {
    pub fn new(
        ...
        let mut state = AppState {
            ...
            show_agent_working_time: config.ui.show_agent_working_time,
    ...
    fn apply_live_config(
        ...
        if !invalid_section("ui") {
            ...
            .is_none()
            {
                ...
                self.state.show_agent_working_time = config.ui.show_agent_working_time;
...
impl App {
    ...
    fn handle_non_terminal_key(&mut self, key: crate::input::TerminalKey) {
        ...
        match self.state.mode {
            ...
            Mode::Review => self.handle_home_key_headless(key),
