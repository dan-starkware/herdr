...
pub struct Keybinds {
    ...
    pub review_toggle: ActionKeybinds,
    pub review_reload: ActionKeybinds,
    pub review_vs_origin: ActionKeybinds,
...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        let mut keybinds = Keybinds {
            ...
            review_toggle: empty_action!(),
            review_reload: empty_action!(),
            review_vs_origin: empty_action!(),
        ...
        for source in [BindingSource::User, BindingSource::Default] {
            ...
            apply_action!(keybinds.review_toggle, review_toggle, source);
            apply_action!(keybinds.review_reload, review_reload, source);
            apply_action!(keybinds.review_vs_origin, review_vs_origin, source);
